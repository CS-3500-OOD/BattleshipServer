...
/**
 * Wrapper for ExecutorService that imposes a hard bound on the number of
 * running tasks, rejecting submissions when the bound is reached. This may
 * be appropriate when the wrapped service has no bound on pool size, and
 * you want to limit thread creation (and you are willing to have tasks
